...
function displayProducts() {
    productList.innerHTML = ""; // İlk başta listeyi temizle
    for (const i of products) {
        productList.innerHTML += `
            <li class="product"> 
                <strong>Thumbnail:</strong> <img src="${i.thumbnail}" alt="">
                <strong>Id:</strong> ${i.id}<br>
                <strong>Brand:</strong> ${i.brand}<br>
                <strong>Tags:</strong> ${i.tags}<br>
                ...
                <strong>Stock:</strong> ${i.stock}<br>
            </li>
        `;
    }
}

displayProducts(); // Başlangıçta tüm ürünleri listele

findBtn.addEventListener("click", () => {
    const searchTerm = searchBar.value.trim().toLowerCase(); // Kullanıcıdan gelen arama terimi

    if (searchTerm === "") {
        alert("Lütfen geçerli bir marka girin!"); // Eğer boş arama yapılırsa uyarı
        return;
    }

    productList.innerHTML = ""; // Arama yapıldığında, mevcut listeyi temizle

    for (const x of products) {
        if (x.brand.toLowerCase() === searchTerm) {
            productList.innerHTML += `
                <li class="product"> 
                    <strong>Thumbnail:</strong> <img src="${x.thumbnail}" alt="">
                    <strong>Id:</strong> ${x.id}<br>
                    <strong>Brand:</strong> ${x.brand}<br>
                    <strong>Tags:</strong> ${x.tags}<br>
                    ...
                    <strong>Stock:</strong> ${x.stock}<br>
                </li>
            `;
            console.log(x.id);
        }
    ...
    if (productList.innerHTML === "") {
        productList.innerHTML = "<p>No products found</p>"; // Arama sonucu bulunamazsa mesaj göster
    }
});
...
// function displayProducts() {
//     for(const i of products) {
//         productList.innerHTML += `<li class="product"> 
//         <strong>Thumbnail:</strong> <img src="${i.thumbnail}" alt=""</img>
//         <strong>Id:</strong> ${i.id}<br>
//         <strong>Brand:</strong> ${i.brand}<br>
//         <strong>Tags:</strong> ${i.tags}<br>
//         <strong>Title:</strong> ${i.title}<br>
...
// findBtn.addEventListener("click", () => {
//     for (const x of products) {
//         if (searchBar.value.trim().toLocaleLowerCase("tr-TR") === x.brand.toLocaleLowerCase("tr-TR")) {
//             productList.innerHTML +=`<li class="product"> 
//             <strong>Thumbnail:</strong> <img src="${x.thumbnail}" alt=""</img>
//             <strong>Id:</strong> ${x.id}<br>
//             <strong>Brand:</strong> ${x.brand}<br>
//             <strong>Tags:</strong> ${x.tags}<br>
//             <strong>Title:</strong> ${x.title}<br>
